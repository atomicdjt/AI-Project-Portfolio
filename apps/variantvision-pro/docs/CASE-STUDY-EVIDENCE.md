...
| **5-Dimension Evidence Quality Scoring** | Normalization, Population, ClinVar, Protein, Literature | `src/modules/evidence/buildDossier.ts` | `src/tests/variantEngine.test.ts` |
