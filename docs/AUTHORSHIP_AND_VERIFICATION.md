...
This portfolio was developed through a human-directed, AI-assisted engineering workflow. This document explains what that means, what the repositories demonstrate, and what should not be inferred.
...
- deciding which generated suggestions to accept, reject, revise, or test;
...
- preserving repository history and separating canonical source from packages and deployments;
- requiring tests, builds, verification records, and explicit limitations before presenting work publicly.

AI systems have been used as implementation, research, drafting, review, and debugging collaborators. The amount and type of assistance varies by project. No repository should be interpreted as a claim that every line was typed manually or produced without automated assistance.
...
| RedactReady Pro | Privacy-first workflow, evidence review and redaction requirements, human confirmation, responsible-use and report boundaries | Detection and UI implementation assistance, testing and documentation support | Local-first architecture, tests/build, evidence mapping, report and case-study documentation | Not independently security-certified and not a substitute for professional review |
...
The documentation, code, commit history, validation commands, and live behavior should be evaluated together.
...
- the relevant README or case study;
- this document when contribution or evidence boundaries materially change.

Automated checks validate core authority and public-status consistency, but human review remains required for nuanced claims.
